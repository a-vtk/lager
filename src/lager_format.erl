...
-export([format/3, format/4, cdata_to_chars/1]).
...
control2($p, [A], _F, _Adj, _P, _Pad, unicode, L) ->
    Term = lager_trunc_io:fprint(A, L, [{lists_as_strings, true},{force_strings, true}]),
